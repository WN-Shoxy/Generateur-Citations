let citationGaucheDebut = ['Abdel','Loïc','Ahmed','Réda', 'Jacques', 'Shkoon'];
let citationGaucheMilieu = ['mange','ingurgite','consomme','absorbe','ingére'];
let citationGaucheFin = ['une pasta box.','un tacos.','un subway.','une côtelette.','un burger.'];

let citationDroiteDebut = ['Une table','Une pasta box','Un tacos','Un subway','Une côtelette','Un burger'];
let citationDroiteMilieu = ['mange','ingurgite','consomme','absorbe','ingére'];
let citationDroiteFin = ['Abdel.','Loïc.','Ahmed.','Réda.'];
